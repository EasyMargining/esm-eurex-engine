...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "esmeurexengine@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "esmeurexengine API";

        private String description = "esmeurexengine API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "esmeurexengine";
